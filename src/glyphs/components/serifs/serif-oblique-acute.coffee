			...
			nodes:
				...
				1:
					...
					y: anchors[0].y + serifHeight - ( ( contours[0].nodes[1].x - Utils.onLine({
						y: anchors[0].y + serifHeight
						on: [ parentAnchors[0].base, parentAnchors[0].obliqueEndPoint ]
					}) ) / ( serifWidth * anchors[3].scaleX - Math.abs( Utils.onLine({
						y: anchors[0].y + serifHeight
						on: [ parentAnchors[0].base, parentAnchors[0].obliqueEndPoint ]
				...
				3:
					x: contours[0].nodes[4].x + ( contours[0].nodes[2].x - contours[0].nodes[4].x ) * 0.5 * ( 1 - ( ( contours[0].nodes[4].x + ( contours[0].nodes[2].x - contours[0].nodes[4].x ) * 0.5 - anchors[0].x ) / serifWidth * anchors[3].scaleX ) * ( serifMedian - 1 ) ) - serifTerminal * serifHeight * anchors[3].scaleX
