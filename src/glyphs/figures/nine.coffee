exports.glyphs['nine'] =
	...
	anchors:
		0:
			junctionTop: Utils.pointOnCurve( contours[0].nodes[3].expandedTo[1], contours[0].nodes[3].expandedTo[1].handleOut, contours[0].nodes[2].expandedTo[1], contours[0].nodes[2].expandedTo[1].handleIn, ( 50 - ( 50 / defaultThickness ) * thickness ) * contrast * contrastExtremity, true, 10 )
			junctionBottom: Utils.pointOnCurve( contours[0].nodes[3].expandedTo[1], contours[0].nodes[3].expandedTo[1].handleOut, contours[0].nodes[2].expandedTo[1], contours[0].nodes[2].expandedTo[1].handleIn, ( ( 100 / defaultThickness ) * thickness + 50 - ( 50 / defaultThickness ) * thickness ) * contrast * contrastExtremity, true, 10 )
	contours:
		0:
			skeleton: true
			closed: false
			...
			nodes:
				0:
					x: Math.max(
						...
						contours[0].nodes[2].expandedTo[1].x + 0.75 * ( 119 / defaultThickness ) * thickness * opticThickness * contrast + 10
					)
					y: ( 635 / 750 ) * capHeight - (16)
					dirOut:( 105 + 15 * contrast ) / 180 * Math.PI
					typeIn: 'smooth'
					expand:
						width: ( 119 / defaultThickness ) * thickness * opticThickness * contrast
						angle:( - 147 ) / 180 * Math.PI
						distr: 0.25
				1:
				...
				2:
					...
					tensionOut: 1.1
					expand:
						width: ( 142 / defaultThickness ) * thickness * opticThickness
				...
				4:
					x: Math.max(
						...
						contours[0].nodes[2].expandedTo[1].x + 0.75 * ( 145 / defaultThickness ) * thickness * opticThickness + 10
					)
				...
				5:
					...
					dirIn: 0
					expand:
						width: ( 113 / defaultThickness ) * thickness * opticThickness * contrast
						angle:( - 103 ) / 180 * Math.PI
						distr: 0.25
		1:
			skeleton: true
			closed: false
						...
						[
							{
								...
								dirIn: Math.max(65,( ( 65 / defaultThickness ) * thickness ) ) / 180 * Math.PI
								typeOut: 'smooth'
							}
							{
								x: anchors[0].junctionBottom.x
								y: anchors[0].junctionBottom.y
								dirIn: Math.min(100,( Math.max(65, ( 90 / defaultThickness ) * thickness )) ) / 180 * Math.PI
								typeOut: 'smooth'
							}
						]
				2:
